...
/**
 * Bitacora de cada consulta al API externo Spin: request, respuesta, latencia,
 * resultado y traza. La tabla esta PARTICIONADA por mes (ver migraciones Flyway).
 */
@Entity
...
public class BitacoraConsumo {
    ...
    public String resultado; // OK | ERROR | TIMEOUT | CIRCUIT_OPEN | RATE_LIMITED
