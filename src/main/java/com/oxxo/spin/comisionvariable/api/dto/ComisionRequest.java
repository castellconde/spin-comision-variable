...
/**
 * Contrato DUMMY de entrada para la consulta de comision variable.
 *
 * <p>La validacion server-side replica el estilo del microservicio
 * {@code receiver} de Oxxocel: Bean Validation declarativa sobre el DTO,
 * con regex y rangos por campo. Los errores se traducen a un
 * {@link ErrorResponse} homogeneo via los exception mappers.</p>
 */
...
public record ComisionRequest(
        ...
        @Schema(description = "Identificador unico de la consulta (idempotencia / trazabilidad)", example = "POS-20260608-000123")
